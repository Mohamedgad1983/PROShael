...
const ExpenseManagement = ({ dateFilter, onExpenseChange }) => {
  ...
  const fetchExpenses = useCallback(async (isRetry = false) => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.REACT_APP_API_URL}/api/financial/expenses?${params}`, {
        headers: {
  ...
  const handleCreateExpense = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.REACT_APP_API_URL}/api/financial/expenses`, {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`
        },
  ...
  const handleApproveExpense = async (expenseId) => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.REACT_APP_API_URL}/api/financial/expenses/${expenseId}/approve`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
  ...
  const handleRejectExpense = async (expenseId, reason) => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.REACT_APP_API_URL}/api/financial/expenses/${expenseId}/reject`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json'
      ...
      <div className="expense-header glass-morphism">
        ...
        <div className="filters-section">
          <div className="search-box">
            ...
            />
            <button className="search-btn" onClick={fetchExpenses}>
              🔍
            </button>
          </div>
