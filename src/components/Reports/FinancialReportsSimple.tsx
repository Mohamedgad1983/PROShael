    ...
    <div style={{ padding: '20px', backgroundColor: '#f5f5f5', minHeight: '500px' }}>
      ...
      <div style={{ backgroundColor: 'white', padding: '20px', borderRadius: '8px', minHeight: '300px' }}>
        ...
        {activeTab === 'expenses' && (
          <div>
            <h2 style={{ fontSize: '20px', marginBottom: '15px', textAlign: 'right' }}>
              إدارة المصروفات - {currentHijriDate.month} {currentHijriDate.year}هـ
            </h2>
            ...
            <div style={{ backgroundColor: '#f9f9f9', padding: '15px', borderRadius: '5px', marginBottom: '15px' }}>
              <h3 style={{ fontSize: '16px', marginBottom: '10px', textAlign: 'right' }}>فئات المصروفات</h3>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '10px' }}>
                <div style={{ padding: '10px', backgroundColor: 'white', borderRadius: '5px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                    <span>تشغيلية</span>
                    <span style={{ color: '#f44336' }}>١٢,٠٠٠ ريال</span>
                  </div>
                </div>
                <div style={{ padding: '10px', backgroundColor: 'white', borderRadius: '5px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                    <span>مناسبات</span>
                    <span style={{ color: '#f44336' }}>٨,٠٠٠ ريال</span>
                  </div>
                </div>
                <div style={{ padding: '10px', backgroundColor: 'white', borderRadius: '5px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                    <span>مبادرات</span>
                    <span style={{ color: '#f44336' }}>٥,٠٠٠ ريال</span>
                  </div>
                </div>
                <div style={{ padding: '10px', backgroundColor: 'white', borderRadius: '5px' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between' }}>
            ...
            {/* Recent Expenses */}
            <div style={{ backgroundColor: '#f9f9f9', padding: '15px', borderRadius: '5px' }}>
              <h3 style={{ fontSize: '16px', marginBottom: '10px', textAlign: 'right' }}>المصروفات الأخيرة</h3>
              <p style={{ textAlign: 'right', color: '#666' }}>سيتم عرض قائمة المصروفات التفصيلية هنا...</p>
            </div>
          </div>
        )}
