...
const CreateDiyaModal: React.FC<CreateDiyaModalProps> = ({
  ...
  const [formData, setFormData] = useState<DiyaFormData>({
    title: '',
    description: '',
  ...
  const validateForm = (): boolean => {
    ...
    if (formData.involvedParties.some(party => !party.name.trim())) {
  ...
  const updateParty = (index: number, field: string, value: any) => {
    setFormData(prev => ({
      ...prev,
      involvedParties: prev.involvedParties.map((party, i) =>
      ...
      <div style={modalStyle} onClick={(e) => e.stopPropagation()}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={sectionStyle}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
              <div style={formGroupStyle}>
                ...
                <select
                  ...
                  onChange={(e) => setFormData(prev => ({ ...prev, caseType: e.target.value as DiyaCaseType }))}
                >
                  {caseTypes.map(type => (
              ...
              <div style={formGroupStyle}>
                ...
                <select
                  ...
                  onChange={(e) => setFormData(prev => ({ ...prev, priority: e.target.value as DiyaPriority }))}
                >
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
              <div style={formGroupStyle}>
                <label style={labelStyle}>تاريخ وقوع الحادث *</label>
                <input
                  type="date"
                  style={{
                    ...inputStyle,
                  ...
                  value={formData.caseDateOccurred}
                  onChange={(e) => setFormData(prev => ({ ...prev, caseDateOccurred: e.target.value }))}
                />
              ...
              <div style={formGroupStyle}>
                ...
                <input
                  ...
                  onChange={(e) => setFormData(prev => ({ ...prev, compensationAmount: parseInt(e.target.value) || 0 }))}
                  min="50"
                />
