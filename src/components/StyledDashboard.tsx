...
import { OccasionsOverview } from './Occasions';
import { InitiativesOverview } from './Initiatives';
import { DiyasOverview } from './Diyas';
    ...
    <div style={styles.container}>
      ...
      <div style={styles.header}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          ...
          <h1 style={{ fontSize: '24px', fontWeight: 'bold' }}>لوحة تحكم الشعيل</h1>
        </div>
        <button
          onClick={onLogout}
          style={{
      ...
      <div style={styles.mainLayout}>
        ...
        <div className="desktop-sidebar" style={styles.sidebar}>
          <div style={{ marginBottom: '2rem' }}>
            <h2 style={{ fontSize: '18px', marginBottom: '8px' }}>عائلة الشعيل</h2>
            <p style={{ fontSize: '14px', color: 'rgba(255, 255, 255, 0.6)' }}>نظام إدارة العائلة</p>
          </div>
            ...
            {isLoading ? (
              ...
              <>
                ...
                {activeSection === 'settings' && (
                  <div>
                    <div style={styles.activitiesCard}>
                      <h3 style={{ fontSize: '18px', marginBottom: '1rem' }}>إعدادات عامة</h3>
                      <div style={{ padding: '1rem' }}>
                        <div style={{ marginBottom: '1.5rem' }}>
                          <label style={{ display: 'block', marginBottom: '8px', fontSize: '14px', color: 'rgba(255, 255, 255, 0.8)' }}>اسم العائلة</label>
                          <input
                            type="text"
                            value="الشعيل"
                            readOnly
                        ...
                        <div style={{ marginBottom: '1.5rem' }}>
                          <label style={{ display: 'block', marginBottom: '8px', fontSize: '14px', color: 'rgba(255, 255, 255, 0.8)' }}>اللغة</label>
                          <select
                            style={{
                              width: '100%',
                              padding: '12px',
