...
async def run_test():
    ...
    try:
        ...
        # Click on تسجيل الدخول button to login as admin
        elem = frame.locator('xpath=html/body/div/div/main/div/div[2]/form/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # -> Fill in the email and password fields correctly and click login button again
        frame = context.pages[-1]
        # Fill in the email input with admin@alshuail.com
        ...
        frame = context.pages[-1]
        # Fill in the password input with Admin@123
        ...
        try:
            ...
            raise AssertionError('Test plan execution failed: Notification sending via Firebase Cloud Messaging, email, SMS with WhatsApp API integration did not succeed as expected. Targeted users did not receive notifications or logs are incorrect.')
