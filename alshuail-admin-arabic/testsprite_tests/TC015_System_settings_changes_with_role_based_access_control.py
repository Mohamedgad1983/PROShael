...
async def run_test():
    ...
    try:
        ...
        try:
            ...
            raise AssertionError('Test plan execution failed: System settings configuration test did not complete successfully, indicating failure in appearance, language, notification settings, or access control enforcement.')
