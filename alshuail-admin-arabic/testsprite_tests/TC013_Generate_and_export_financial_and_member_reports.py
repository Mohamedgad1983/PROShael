...
async def run_test():
    ...
    try:
        ...
        # -> Re-enter email and password fields and click login button again
        frame = context.pages[-1]
        # Re-enter email in the email input field
        ...
        frame = context.pages[-1]
        # Re-enter password in the password input field
        ...
        # -> Retry login by clearing and re-entering credentials and clicking login button again
        frame = context.pages[-1]
        ...
        try:
            ...
            raise AssertionError('Test plan execution failed: Report generation functionality including financial statements, subscription reports, member statistics, and export verification did not complete successfully.')
