...
async def run_test():
    ...
    try:
        ...
        # -> Navigate to report generation page from dashboard or menu
        frame = context.pages[-1]
        # Click on dashboard or main menu to find report generation page
        ...
        try:
            ...
            raise AssertionError("Test failed: The system did not handle invalid report date ranges gracefully. Expected a validation error message and no report generation, but 'Report Generated Successfully' was not found, indicating failure to stop report generation on invalid input.")
