...
async def run_test():
    ...
    try:
        ...
        # -> Retry login or check for alternative login page or error details
        frame = context.pages[-1]
        ...
        try:
            ...
            raise AssertionError('Test case failed: Admin dashboard did not load real-time statistics, charts, and recent activities within acceptable performance limits (<=3 seconds).')
