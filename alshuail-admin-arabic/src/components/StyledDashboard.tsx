    ...
    return (
      <div style={{ animation: 'fadeInUp 0.6s ease-out' }}>
        ...
        {subscriptionsTab === 'plans' && (
          <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
              <h3 style={{ fontSize: '20px', fontWeight: '400' }}>خطط الاشتراك</h3>
              <button
              ...
              {plans.map((plan) => (
                ...
                >
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '1rem' }}>
                    <div>
                      <h4 style={{ fontSize: '18px', fontWeight: '400', marginBottom: '0.5rem' }}>{plan.name_ar}</h4>
                  ...
                  <div style={{ marginBottom: '1.5rem' }}>
                    <div style={{ fontSize: '32px', fontWeight: '400', color: '#4facfe', marginBottom: '0.5rem' }}>
                  ...
                  <div style={{ marginBottom: '1.5rem' }}>
                    <h5 style={{ fontSize: '14px', fontWeight: '400', marginBottom: '0.5rem' }}>المزايا:</h5>
        ...
        {subscriptionsTab === 'members' && (
          <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
              <h3 style={{ fontSize: '20px', fontWeight: '400' }}>اشتراكات الأعضاء</h3>
        ...
        {subscriptionsTab === 'schedule' && (
          <div>
            <h3 style={{ fontSize: '20px', fontWeight: '400', marginBottom: '2rem' }}>جدول المدفوعات</h3>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.5rem' }}>
              ...
              <div style={{
                ...
                <h4 style={{ fontSize: '16px', fontWeight: '400', marginBottom: '1rem', color: '#f59e0b' }}>
                  ...
                  {subscriptions.filter(sub => {
                    ...
                    <div key={subscription.id} style={{
                      ...
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        ...
                        <div style={{ textAlign: 'left' }}>
                          <div style={{ fontSize: '14px', fontWeight: '400', color: '#f59e0b' }}>
                            {subscription.amount} ر.س
                          </div>
                          <div style={{ fontSize: '12px', color: 'rgba(255, 255, 255, 0.7)' }}>
                            {formatHijriDate(subscription.due_date)}
              ...
              <div style={{
                ...
                <h4 style={{ fontSize: '16px', fontWeight: '400', marginBottom: '1rem', color: '#ef4444' }}>
                  مدفوعات متأخرة
                </h4>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                  {subscriptions.filter(sub => sub.status === 'overdue').map((subscription) => (
                    <div key={subscription.id} style={{
                      ...
                      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                        ...
                        <div style={{ textAlign: 'left' }}>
                          <div style={{ fontSize: '14px', fontWeight: '400', color: '#ef4444' }}>
                            {subscription.amount} ر.س
                          </div>
                          <div style={{ fontSize: '12px', color: 'rgba(255, 255, 255, 0.7)' }}>
                            {formatHijriDate(subscription.due_date)}
        ...
        {subscriptionsTab === 'analytics' && (
          <div>
            <h3 style={{ fontSize: '20px', fontWeight: '400', marginBottom: '2rem' }}>تحليلات الاشتراكات</h3>
            ...
            <div style={{
              ...
              <h4 style={{ fontSize: '16px', fontWeight: '400', marginBottom: '1rem' }}>إيرادات الاشتراكات</h4>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.5rem' }}>
              <div style={{
                ...
                <h4 style={{ fontSize: '16px', fontWeight: '400', marginBottom: '1rem' }}>توزيع الخطط</h4>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                  {plans.map((plan) => {
              ...
              <div style={{
                ...
                <h4 style={{ fontSize: '16px', fontWeight: '400', marginBottom: '1rem' }}>إحصائيات سريعة</h4>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                    ...
                    <span style={{ fontSize: '14px', fontWeight: '400', color: '#10b981' }}>+15%</span>
                  </div>
                  <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                    <span style={{ fontSize: '14px', color: 'rgba(255, 255, 255, 0.8)' }}>معدل الإلغاء:</span>
                    <span style={{ fontSize: '14px', fontWeight: '400', color: '#ef4444' }}>3%</span>
                  </div>
                  <div style={{ display: 'flex', justifyContent: 'space-between' }}>
        ...
        {showSubscriptionModal && (
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
                <h3 style={{ fontSize: '20px', fontWeight: '400' }}>اشتراك عضو جديد</h3>
                <button
    ...
    <div style={styles.container}>
      ...
      <div style={styles.header}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          ...
          <h1 style={{ fontSize: '24px', fontWeight: '400', color: '#007AFF' }}>لوحة تحكم صندوق شعيل العنزي</h1>
        </div>
        <button
          onClick={onLogout}
          style={{
      ...
      <div style={styles.mainLayout}>
        ...
        <div className="desktop-sidebar" style={styles.sidebar}>
          <div style={{ marginBottom: '2rem', textAlign: 'center' }}>
            ...
            />
            <h2 style={{ fontSize: '20px', marginBottom: '8px', color: '#ffffff', fontWeight: '400' }}>صندوق شعيل العنزي</h2>
                ...
                <div style={styles.sectionHeader}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                    ...
                    <div style={{ textAlign: 'right', padding: '8px 16px', background: 'rgba(255, 255, 255, 0.1)', borderRadius: '12px' }}>
                      <div style={{ fontSize: '18px', fontWeight: '400', color: '#10b981', marginBottom: '4px' }}>
