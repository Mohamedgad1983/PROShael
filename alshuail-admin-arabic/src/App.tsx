...
// Admin Dashboard Component with Login
        ...
        <div className="apple-login-card">
          ...
          <form className="apple-login-form" onSubmit={handleSubmit} dir="rtl">
            ...
            <button type="submit" className="apple-login-button">
              ...
              <svg className="apple-button-arrow" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="apple-footer-section">
            <p className="apple-security-text">
              <svg className="apple-security-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
