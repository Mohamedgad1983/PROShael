...
export const FAMILY_FINANCING_POLICY_VERSION = 4;
 ...
 */
export const FAMILY_FINANCING_TERMS_VERSION = 'family_financing_terms_ar_v4_2026-08-17';
...
كما ألتزم بسداد مبلغ تمويل السلعة والرسوم التشغيلية حسب جدول الأقساط الذي تعتمده الإدارة، بحد أقصى 12 شهراً، مع إمكانية السداد المبكر لكامل المبلغ المتبقي عبر التطبيق.`;
...
export function normalizeFamilyFinancingTiers(_rawTiers) {
  ...
  // Always canonicalise stale or malformed settings for future requests;
