/**
 * =====================================================
 * AL-SHUAIL FAMILY FUND - WHATSAPP SERVICE
 * =====================================================
 ...
 */
const sendWhatsAppOTP = async (phone, otp, memberName = '') => {
    try {
 ...
 * @returns {Promise<{success: boolean, message: string}>}
 */
const sendPasswordResetNotification = async (phone, memberName = '') => {
    try {
        const formattedPhone = formatPhoneNumber(phone);
 ...
 * @returns {Promise<{success: boolean, message: string}>}
 */
const sendWelcomeMessage = async (phone, memberName, membershipId) => {
    try {
        const formattedPhone = formatPhoneNumber(phone);
