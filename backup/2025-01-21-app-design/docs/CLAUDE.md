...
## Project Overview
Al-Shuail Family Admin Dashboard - A premium, Apple-inspired admin system with member management, financial tracking, and document handling capabilities. Features glassmorphism design, sophisticated animations, and full RTL support for Arabic interface.
...
# Development server with auto-reload (port 3001)
npm run dev
...
Always start backend first (port 3001), then frontend (port 3002).
